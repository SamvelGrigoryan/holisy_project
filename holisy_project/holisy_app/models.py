...
#     booking_id = models.ForeignKey(Booking, on_delete=models.CASCADE, null=True, related_name='topic_bookings_id',
#                                    verbose_name='Номер брони')
#     service_id = models.ForeignKey(Service, on_delete=models.CASCADE, null=True, related_name='topic_service_id',
#                                    verbose_name='Идентификатор услуги')
